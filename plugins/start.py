...
async def start_command(client: Client, message: Message):
    ...
    if len(text)>7:
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton("⚪ Main Channel ⚪", url = f"https://t.me/ROCKERSBACKUP"),
                ]
            ]
        )
    ...
    buttons = [
        [
            InlineKeyboardButton(
                "Join Channel",
                url = f"https://t.me/JNKFREELOOTS"),
            InlineKeyboardButton(
                "Join Channel",
                url = f"https://t.me/+KY2CkUJmVIE2N2Rl")
        ],[
            InlineKeyboardButton(
                "Join Channel",
                url = f"https://t.me/+hd1Gi3vAfXVmZTRl"),
            InlineKeyboardButton(
                "Join Channel",
                url = f"https://t.me/+VfQwY6vS-WgzMjVl")
        ],[   
            InlineKeyboardButton(
                "Join Channel",
                url = f"https://t.me/+p-3KeROvJR00Yjc9"),
            InlineKeyboardButton(
                "Join Channel",
                url = f"https://t.me/+rK95YhWrUmIxNTNl")
        ],[
            InlineKeyboardButton(
                "Join Channel",
                url = f"https://t.me/+OzTTKS0gPsc5NDI1"),
            InlineKeyboardButton(
                "Join Channel",
                url = f"https://t.me/+nClfK030vtsxNjNl")
        ],[
            InlineKeyboardButton(
                "Join Channel",
                url = f"https://t.me/+SnIclI9_HK9lZWU9"),
            InlineKeyboardButton(
                "Join Channel",
                url = ButtonUrl)
    ]]
